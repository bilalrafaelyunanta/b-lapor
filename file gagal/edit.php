...
<div id="layoutSidenav_content">  
  <form action="../proses/proses_edit.php" method="POST">
    <div class="card-body">
      <div class="fs-4 fw-bolder mb-3">Form Edit Laporan</div>
      ...
      <div class="form-group">
        ...
        <img src="../img_laporan/<?php echo $hasil['foto']?>" class="w-52 px-3 py-4 rounded-3 form-control" width="600px"/>
      </div>
        <div class="px-2">
            <button type="submit" name="oke" class="bg-yellow-500 mt-4 btn btn-warning btn-icon-split">
                <span class="icon text-white-50">
